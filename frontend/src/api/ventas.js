...
export const despacharProducto = (id, cantidad_despachada) => client.patch(`/api/ventas/productos/${id}/despachar`, cantidad_despachada !== undefined ? { cantidad_despachada } : {}).then(r => r.data);
